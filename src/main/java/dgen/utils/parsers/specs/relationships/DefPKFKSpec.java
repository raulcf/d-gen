...
public class DefPKFKSpec implements DatabaseRelationshipSpec {
    /*
    ...
    public static void validateColumns(DefForeignKeySpec foreignKey, PrimaryKeySpec primaryKey) {
        // TODO: Add more robust type checking
        if (foreignKey.getDataTypeSpec() != null && foreignKey.getDataTypeSpec().type() != primaryKey.getDataTypeSpec().type()) {
            throw new DGException("Foreign key not compatible with primary key");
        }
    }
